...
class MenuWidget extends StatefulWidget {
  ...
  MenuWidget(
      {Key? key, required this.parentScaffoldKey, required this.routeArgument})
      : super(key: key);
}
            ...
            (_con?.categories.isEmpty ?? false)
                ...
                : Container(
                    ...
                    child: ListView(
                      ...
                      children: List.generate((_con?.categories.length ?? 0), (index) {
                        var _category = _con?.categories.elementAt(index);
                        var _selected =
                            this.selectedCategories?.contains(_category?.id) ?? false;
                        return Padding(
