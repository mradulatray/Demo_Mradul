...
import 'src/pages/tcPrivacyPolicy.dart';
...
import 'src/pages/fav_pages.dart';
...
import 'src/pages/new_menu_list.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      // return MaterialPageRoute(builder: (_) => MenuNewWidget());
      case '/Favorites':
        return MaterialPageRoute(
            builder: (_) => FavPageWidget(currentTab: args));
      //return MaterialPageRoute(builder: (_) => PagesWidget(currentTab: 4));
      // case '/Favorites':
      //   final GlobalKey<ScaffoldState> parentScaffoldKey = GlobalKey<ScaffoldState>();
      //   return MaterialPageRoute(
      //     builder: (context) => FavoritesWidget(parentScaffoldKey: parentScaffoldKey),
      //   );
      case '/Chat':
        return MaterialPageRoute(
      ...
      case '/Menu':
        return MaterialPageRoute(
            builder: (_) =>
                MenuNewWidget(/*routeArgument: args as RouteArgument)*/));
      case '/Food':
        return MaterialPageRoute(
      ...
      case '/Privacy':
        return MaterialPageRoute(
            builder: (_) => tcPrivacyPolicy(
                routeArgument: RouteArgument(param: 'Privacy')));
      case '/Terms':
        return MaterialPageRoute(
            builder: (_) =>
                tcPrivacyPolicy(routeArgument: RouteArgument(param: 'Terms')));
