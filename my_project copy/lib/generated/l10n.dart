...
class S {
  ...
  String get unknown {
    return Intl.message(
      ...
      name: 'Please add your address here',
      desc: '',
      args: [],
    );
  }
  ...
  String get your_credit_card_not_valid {
    return Intl.message(
      'Your card information not valid',
  ...
  String get weAreSendingSmsToValidateYourMobileNumberHang {
    return Intl.message(
      'We had sent a code to validate your mobile number',
      //'Hang on!',
      name: 'weAreSendingSmsToValidateYourMobileNumberHang',
      desc: '',
      args: [],
    );
  }
